...
public class NewsData {
    ...
    public static ArrayList<BreakingAndLatestNews> loadBreakingLatestNews(Context context) {
//        public NewsObj(String id, String newsCategory, String img, String title, String reportedBy, String date, String desc)
        ...
        listModels1.add(new NewsObj("", "", img,
                "p1c1" + context.getResources().getString(R.string.news_title_republica), "Andy Rubin", "Thu, 11-11-2015",
                context.getResources().getString(R.string.news_description_republica)
        ));
        listModels1.add(new NewsObj("", "", img,
                "p1c2" + context.getResources().getString(R.string.news_title_republica), "Andy Rubin", "Thu, 11-11-2015",
                context.getResources().getString(R.string.news_description_republica)
        ));
        listModels1.add(new NewsObj("", "", img,
                "p1c3" + context.getResources().getString(R.string.news_title_republica), "Andy Rubin", "Thu, 11-11-2015",
                context.getResources().getString(R.string.news_description_republica)
        ));
        ...
        breakingAndLatestNewses.add(new BreakingAndLatestNews("Breaking News", listModels1));
        breakingAndLatestNewses.add(new BreakingAndLatestNews("Latest News", listModels2));
    ...
    public static ArrayList<ExtraModel> getExtraList() {
        ...
        list.add(new ExtraModel("1", "", "Horroscope"));
        list.add(new ExtraModel("2", "", "Loadsheding"));
        list.add(new ExtraModel("3", "", "Bullion"));
        list.add(new ExtraModel("4", "", "Exchange Rate"));
        list.add(new ExtraModel("5", "", "Stock"));
        list.add(new ExtraModel("6", "", "Today's Significane"));
        return list;
    }
